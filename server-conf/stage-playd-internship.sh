...
PLAY_APPLICATION_NAME=internship-task
PLAY_APPLICATION_PATH=/root/internship-task/target/universal/stage
PLAY_PORT=8090
PLAY_STATUS_METHOD=HTML
PLAY_HTML_CHECK_STRING="PONG"
PLAY_HTML_CHECK_URL=http://localhost:8090/ping

# VARIABLES SETUP

PLAY_ARGS="-Dhttp.port=${PLAY_PORT} -Dlogger.file=/opt/conf/play/internship-prod-logback.xml -Dconfig.file=/opt/conf/play/stage-application.conf"
